...
namespace KeyEngine
{
    public class EntityCollection : IEnumerable
    {
        ...
        public Entity Find(int instanceId) => Entities[Entities.FindIndex(e => e.HashId == instanceId)];
        public int FindIndex(string name) => Entities.FindIndex(e => e.Name == name);
        public int FindIndex(int instanceId) => Entities.FindIndex(e => e.HashId == instanceId);
