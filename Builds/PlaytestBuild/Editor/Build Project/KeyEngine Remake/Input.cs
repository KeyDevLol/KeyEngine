...
namespace KeyEngine
{
    ...
    public static class Input
    {
        ...
        /// <returns>If the key has just been pressed: true</returns>
        ...
        /// </summary>
        /// <param name="key">KeyCode</param>
        /// <returns>If the key was just released: true</returns>
        ...
        /// <summary>
        /// The key is pressed and held
        /// </summary>
        /// <param name="key">KeyCode</param>
        /// <returns>While the key is held: true</returns>
        ...
        {
            if (IsKeyHold(negativeKey) && !IsKeyHold(positiveKey))
                return -minMax;
            else if (IsKeyHold(positiveKey) && !IsKeyHold(negativeKey))
                return minMax;
