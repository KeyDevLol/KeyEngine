...
namespace KeyEngine
{
    public class InspectorTestComponent : Component
    {
        ...
        public override void Start()
        {
            ...
            var tex = AssetsManager.GetAsset<Texture>("Assets/Textures/test.png");
            var tex2 = AssetsManager.GetAsset<Texture>("Assets/Textures/test.png");
            var tex3 = AssetsManager.GetAsset<Texture>("Assets/Textures/test.png");
            var tex4 = AssetsManager.GetAsset<Texture>("Assets/Textures/test.png");
            var tex5 = AssetsManager.GetAsset<Texture>("Assets/Textures/test.png");
            var tex6 = AssetsManager.GetAsset<Texture>("Assets/Textures/test.png");

            Log.Print(tex == null);

            spriteRenderer.Texture = tex6;
        }
