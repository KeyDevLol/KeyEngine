...
namespace KeyEngine 
{
    public class TestScene : IScene
    {
        ...
        public void Load()
        {
            Texture texture = new Texture(@"C:\Users\derry\Downloads\PressF.jpg");
            Log.Print(texture.Handle);

            //ECS.AddEntity("Hello Entity").AddComponent<SpriteRenderer>();
            ECS.AddEntity("Hello Entity 1").AddComponent<SpriteRenderer>().Owner.Position = new Vector2(-3, 0);
            ECS.AddEntity("Lol").AddComponent<InspectorTestComponent>();
